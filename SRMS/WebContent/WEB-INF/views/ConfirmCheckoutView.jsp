...
<div class = "checkin-page">
	...
	<form:form action = "outVisitor" method = "post">
	<div class = "input-group mb-3">
		<div class = "input-group-prepend">
			<span class = "input-group-text"><i class = "fa fa-user fa-fw"></i></span>
			<form:input path = "visName" class = "form-control" disabled = "true"/>
		</div>
	</div>
	<div class = "input-group mb-3">
		<div class = "input-group-prepend">
			<span class = "input-group-text"><i class = "fa fa-envelope fa-fw"></i></span>
			<form:input path = "visEmail" class = "form-control"/>
		</div>
	</div>
	<div class = "input-group mb-3">
		<div class = "input-group-prepend">
			<span class = "input-group-text"><i class = "fa fa-phone fa-fw"></i></span>
			<form:input path = "visPhone" class = "form-control" disabled = "true"/>
		</div>
	</div>
	<div class = "input-group mb-3">
		<div class = "input-group-prepend">
			<span class = "input-group-text"><i class = "fa fa-id-badge fa-fw"></i></span>
			<form:input path = "badgeId" class = "form-control" disabled = "true"/>
		</div>
	</div>
	<div class = "input-group mb-3">
		<div class = "input-group-prepend">
			<span class = "input-group-text"><i class = "fa fa-archive fa-fw"></i></span>
			<form:input path = "visPurpose" class = "form-control" disabled = "true"/>
		</div>
	</div>
	<div class = "input-group mb-3">
		<div class = "input-group-prepend">
			<span class = "input-group-text"><i class = "fa fa-building fa-fw"></i></span>
			<form:input path = "visCompany" class = "form-control" disabled = "true"/>
		</div>
	</div>
	<br>
	<input class="btn btn-primary" type="submit" value="Check Out" style="width:100px"/>
	</form:form>
	</div>
</div>
