...
<div class = "checkin-page">
	...
	<div class = "input-group mb-3">
		...
		<input class = "form-control" type="text" placeholder = "Enter Email" name="visEmail" class="col-lg-12" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required/>
	</div>
	</div>
	<br>
	<input type="submit" value="Check In"  class="btn btn-primary" style = "width:100px"/>
	</form>
